...
class Settings_model extends CI_Model {
  ...
  public function update_system_settings() {
    ...
    $response = array(
      'status' => true,
      'message' => get_phrase('system_settings_updated_successfully')
    );
  ...
  public function update_system_logo() {
    if ($_FILES['dark_logo']['name'] != "") {
      move_uploaded_file($_FILES['dark_logo']['tmp_name'], 'public/siteweb/img/logo/logo-dark.png');
    }
    if ($_FILES['light_logo']['name'] != "") {
      move_uploaded_file($_FILES['light_logo']['tmp_name'], 'public/siteweb/img/logo/logo-light.png');
    }
    if ($_FILES['small_logo']['name'] != "") {
      move_uploaded_file($_FILES['small_logo']['tmp_name'], 'public/siteweb/img/logo/logo-light-sm.png');
    }
    if ($_FILES['favicon']['name'] != "") {
      move_uploaded_file($_FILES['favicon']['tmp_name'], 'public/siteweb/img/logo/favicon.png');
    }

    $response = array(
      'status' => true,
      'message' => get_phrase('logo_updated_successfully')
    );
    return json_encode($response);
  }
  ...
  function get_application_details() {
    ...
    public function get_logo_dark($type = "") {
      if ($type == 'small') {
        return base_url('public/siteweb/img/logo/logo-dark-sm.png');
      }else{
        return base_url('public/siteweb/img/logo/logo-dark.png');
      }
    ...
    public function get_logo_light($type = "") {
      if ($type == 'small') {
        return base_url('public/siteweb/img/logo/logo-light-sm.png');
      }else{
        return base_url('public/siteweb/img/logo/logo-light.png');
      }
    }

    // GET FAVICON
    public function get_favicon() {
      return base_url('public/siteweb/img/logo/favicon.png');
    }
  }
