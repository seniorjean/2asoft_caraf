    ...
    <div class="container">
      ...
      <form class="form-signin" action="<?= base_url('users/auth/login') ?>" method="post">
        ...
        <div class="login-wrap">
            ...
            <a href="<?=base_url();?>" class="btn btn-lg btn-login" style="background-color: #41cac0; box-shadow: 0 4px #37afa6;" type="button"><i class="fa fa-home"></i></a>
            <button class="btn btn-lg btn-login" type="submit" style="width: 80%;">Connexion</button>
