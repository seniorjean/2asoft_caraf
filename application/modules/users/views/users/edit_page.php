...
<!--                            </li>-->
<!--                            <li>-->
                                <a href="<?=bs()?>users/article/change_image_page/<?php echo $page_details->id ?>" class="btn btn-primary">
                                   Changer l'image
                                </a>
<!--                            </li>-->
<!--                            <li>-->
                ...
                <aside class="profile-info col-lg-9">
                    <section class="panel">
                        ...
                        <div class="panel-body bio-graph-info">
                            <form method="post" action="<?=bs()?>users/article/edit_page/<?php echo $page_details->id ?>">
