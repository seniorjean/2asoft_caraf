                ...
                <section class="panel">
                    ...
                    <div class="panel-body bio-graph-info">
                        <div class="row">
                            ...
                            <div class="bio-row"><p><span class="text-black">Prénoms</span>: <?php echo $user_profile->last_name ?></p></div>

                            <div class="bio-row"><p><span class="text-black">Email </span>: <?php echo $user_profile->email ?></p></div>
                            <div class="bio-row"><p><span class="text-black">Téléphone</span>: <?php echo $user_profile->phone ?></p></div>

                            <div class="bio-row"><p><span class="text-black">Date d'adhésion</span>: <?php echo $user_profile->date ?></p></div>
							...
							<div class="bio-row">
								<p><span class="text-black">Dernière connexion</span>:
									<?php
