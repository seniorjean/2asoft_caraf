...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form enctype="multipart/form-data" action="<?=base_url('slide_builder/add');?>" class="ajax-form" id="slide_builder_form" onsubmit="ajax_submit_form_callback = after_update();">
                    <!--progress bar start-->
                    <section class="panel">
                        <header class="panel-heading">
                            <i class="fa far fa-newspaper"></i> SlideBuilder
                        </header>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <button type="button" class="btn btn-secondary slide_model" data-model="model1">
                                                                    <img src="<?=assets_url('siteweb/img/slides/model1.png');?>" width="100%" height="70px" alt="">
                                                                </button>
                                                            </div>

                                                            <div class="col-sm-3">
                                                                <button type="button" class="btn btn-secondary slide_model" data-model="model2">
                                                                    <img src="<?=assets_url('siteweb/img/slides/model2.png');?>" width="100%" height="70px" alt="">
                                                                </button>
                                                            </div>

                                                            <div class="col-sm-3">
                                                                <button type="button" class="btn btn-secondary slide_model" data-model="model3">
                                                                    <img src="<?=assets_url('siteweb/img/slides/model3.png');?>" width="100%" height="70px" alt="">
                                                                </button>
                                                            </div>
                                                            <div class="col-sm-3">
                                                                <button type="button" class="btn btn-secondary slide_model" data-model="model3 type_b">
                                                                    <img src="<?=assets_url('siteweb/img/slides/model3b.png');?>" width="100%" height="70px" alt="">
                                                                </button>
                                                            </div>
                                                            <input id="model" type="hidden" name="model" required>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <section id="step2" class="panel" style="display: none">
                        <div class="panel-body">
                            <div class="row justify-content-center">
                                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div id="model-container" class="model3">
                                                <div class="i1 m-item">
                                                    <div class="custom-file-upload">
                                                        <label for="slider_image_1" class="btn">
                                                            <select name="i1_category" class="has-text i-category" style="left: 0px;" required>
                                                                ...
                                                                <option value="Nécroloie">Nécroloie</option>
                                                                <option value="Développement">Développement</option>
                                                                <option value="Activités">Activités</option>
                                                            </select>
                                                            <textarea name="i1_title" class="has-text i-content" placeholder="Titre de l’article"></textarea>
                                                            <div class="bottom-mask"></div>
                                                            <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                                <div class="image-box" style="width: 100%;">
                                                                    <div class="js--image-preview" style="background-image: url(<?=base_url('public/yafeca/assets/img/main-slider-overlay.png');?>);background-color: #F5F5F5;"></div>
                                                                    <div class="dis-none">
                                                    ...
                                                    <div class="i2 m-item">
                                                        <div class="custom-file-upload">
                                                            <label for="slider_image_2" class="btn">
                                                                ...
                                                                <textarea name="i2_title" class="has-text i-content model2-field" placeholder="Titre de l’article"></textarea>
                                                                <div class="bottom-mask"></div>
                                                                <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                                    <div class="image-box" style="width:100%;">
                                                                        <div class="js--image-preview" style="background-image: url(<?=base_url('public/yafeca/assets/img/main-slider-overlay.png');?>);background-color: #F5F5F5;"></div>
                                                    ...
                                                    <div class="i3 m-item">
                                                        <div class="custom-file-upload">
                                                            <label for="slider_image_3" class="btn">
                                                                ...
                                                                <textarea name="i3_title" class="has-text i-content model3-field" placeholder="Titre de l’article"></textarea>
                                                                <div class="bottom-mask"></div>
                                                                <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                                    <div class="image-box" style="width: 100%;">
                                                                        <div class="js--image-preview" style="background-image: url(<?=base_url('public/yafeca/assets/img/main-slider-overlay.png');?>);background-color: #F5F5F5;"></div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="bnt btn btn-primary btn-block">Ajouter</button>
                        </div>
                    </section>
