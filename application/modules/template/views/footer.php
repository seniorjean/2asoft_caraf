<a data-toggle="modal" href="#SweetModal" class="dis-none"></a>
<div class="modal fade col-xs-12" id="SweetModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div id="sweetModalDialog" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <button type="button" class="btn-link pull-right print_me dis-none" data-target="#SweetModal #sweetModalBody" style="margin-top:-5px" data-toggle="tooltip" data-placement="top" title="Imprimer"><i class="mdi-printer mdi"></i></button>
...
<a data-toggle="modal" href="#SweetModal2" class="dis-none"></a>
<div class="modal fade col-xs-12" id="SweetModal2" tabindex="-1" role="dialog" aria-hidden="true">
    <div id="sweetModalDialog" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <button type="button" class="btn-link pull-right print_me dis-none" data-target="#SweetModal2 #sweetModalBody" style="margin-top:-5px" data-toggle="tooltip" data-placement="top" title="Imprimer"><i class="mdi-printer mdi"></i></button>
...
<a data-toggle="modal" href="#SweetModal3" class="dis-none"></a>
<div class="modal fade col-xs-12" id="SweetModal3" tabindex="-1" role="dialog" aria-hidden="true">
    <div id="sweetModalDialog" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <button type="button" class="btn-link pull-right print_me dis-none" data-target="#SweetModal3 #sweetModalBody" style="margin-top:-5px" data-toggle="tooltip" data-placement="top" title="Imprimer"><i class="mdi-printer mdi"></i></button>
    ...
    <script src="<?=bs()?>public/libs/angular/angular.min.js"></script>
    ...
    <script src="<?=bs()?>public/libs/select2/select2.min.js"></script>
     <script src="<?=bs()?>public/libs/tooltip/popper.min.js"></script>
     <script src="<?=bs()?>public/libs/tooltip/custom.min.js"></script>
  ...
  <!-- <script src="--><?//=bs()?><!--public/libs/print_me_master/jquery-printme.min.js"></script>-->
...
<script src="<?=bs()?>public/assets/jquery-knob/js/jquery.knob.js"></script>
 ...
 <script>
     const unknow_image = base_url+'uploads/empty_box.png';
