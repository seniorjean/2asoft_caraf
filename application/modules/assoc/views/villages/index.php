            ...
            <div class="col-lg-12">
                ...
                <section class="">
                    <header class="panel-heading">
                        <i class="fas far fa-images"></i> Village /
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="dynamic-table" class="table table-striped table-bordered text-center" cellspacing="0">
                                <thead>
                                <tr>
                                    <th class="text-center">Nom du Village</th>
...
<script>
    const add_form = '<form action="'+base_url+'assoc/villages/add" class="ajax-form" onsubmit="ajax_submit_form_callback = after_create">'+
        '    <div class="row">'+
        '        <div class="col-sm-4">'+
		...
		'<?php foreach($communes as $com):?> <option value="<?=$com->id;?>"><?=$com->name;?></option>   <?php endforeach;?>' +
		'</select>'+
		'</div>' +
		'</div>'+
        '        <div class="col-sm-4">'+
