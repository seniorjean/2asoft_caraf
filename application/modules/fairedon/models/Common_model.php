...
class Common_model extends CI_Model
{
	...
	public function get_3_p_activit()
	{
    ...
    public function alaune_liste2($table)
	{
		//$query = $this->db->query( "SELECT  a.title as titre_cat, a.cat, b.*  from categories a , article b WHERE b.cat = a.id  and a.cat!=15 GROUP BY a.id ");
		$this->db->select('*');
		$this->db->from($table);
	...
	public function listeagendayafeca($table){
	...
	public function presentation($table){
		// return  $this->divacom_evf->get('offre');
