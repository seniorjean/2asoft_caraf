...
if (! function_exists('get_settings')) {
  function get_settings($type = '') {
    $CI	=&	get_instance();
    $CI->load->database();
    $result = $CI->db->get_where('system_settings')->row_array();
    return $result[$type];
  }
}
...
if (! function_exists('timezone')) {
  function timezone($type = '') {
    $CI	=&	get_instance();
    $CI->load->database();
    $result = $CI->db->get_where('home_land_settings', array('id' => 1))->row_array();
...
if (! function_exists('currency')) {
  function currency($price = "") {
    $CI	=&	get_instance();
    $CI->load->database();
    $settings_data = $CI->db->get_where('home_land_settings', array('id' => 1))->row_array();
